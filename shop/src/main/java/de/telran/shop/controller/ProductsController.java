...
//    private ProductsRepository repository;
    ...
    // напишите метод getAll() который вернет все товары из репо
    // по GET запросу к http://localhost:8080/products
    @GetMapping("/products")
    ...
    public ResponseEntity<List<Product>> getPage(
            @RequestParam (name = "size", defaultValue = "5") int pageSize, // сколько товаров на странице
            @RequestParam (name = "page", defaultValue = "0") int pageNumber // какая страница
    )
    {
